...
public class UserModel extends BaseModel {
	...
	public UserModel findByPK(long pk) throws ApplicationException {
		log.debug("Model findByPK Started common");
	...
	public void update() throws ApplicationException,
		...
		try {
			...
			pstmt.setString(15, modifiedBy);
			pstmt.setDate(16, new java.sql.Date(createdDatetime.getTime()));
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			while (rs.next()) {
				...
				bean.setUnsuccessfulLogin(rs.getInt(9));
				bean.setGender(rs.getString(10));
				bean.setLastLogin(rs.getTimestamp(11).toString());
				bean.setUserLock(rs.getString(12));
				bean.setRegisteredIp(rs.getString(13));
				bean.setLastLogin(rs.getString(14).toString());
				bean.setCreatedBy(rs.getString(15));
				bean.setModifiedBy(rs.getString(16));
				bean.setCreatedDatetime(rs.getTimestamp(17));
				bean.setModifiedDatetime(rs.getTimestamp(18));
	...
	public boolean forgetPassword(String login) throws ApplicationException,
		...
		EmailMessage msg = new EmailMessage();
		msg.setTo(login);
		msg.setSubject("OCFMS Password reset");
		msg.setMessage(message);
		msg.setMessageType(EmailMessage.HTML_MSG);
		EmailUtility.sendMail(msg);
		flag = true;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see in.co.ocha.bean.DropdownListBean#getKey()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see in.co.ocha.bean.DropdownListBean#getValue()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see in.co.ocha.model.BaseModel#getTableName()
	 */
	@Override
