...
import in.co.ocha.bean.DropdownListBean;
...
public class HTMLUtility {
	...
	public static String getErrorMessage(HttpServletRequest request) {
		...
		if (!DataValidator.isNull(msg)) {
			msg = "<p class='st-error-header' style='color:red'>" + msg + "</p>";
		}
		return msg;
	}
	...
	public static String getSuccessMessage(HttpServletRequest request) {
		...
		if (!DataValidator.isNull(msg)) {
			msg = "<p class='st-success-header' style='color:green'>" + msg + "</p>";
		}
		return msg;
	}

	/**
	 * Create submit button if user has access permission.
	 * 
	 * @param label
	 * @param access
	 * @param request
