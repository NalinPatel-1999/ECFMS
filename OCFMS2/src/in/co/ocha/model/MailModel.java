...
public class MailModel extends BaseModel {
	...
	public long add() throws ApplicationException {
		...
		try {
			...
			String sql = "INSERT INTO "+getTableName()+" (ID,SENDER,DETAIL,ATTACHMENT) VALUES(?,?,?,?)";
	...
	public void update() throws ApplicationException {
		...
		try {
			conn = JDBCDataSource.getConnection();
			conn.setAutoCommit(false); // Begin transaction
			String sql = "UPDATE "+getTableName()+" SET SENDER = ?,DETAIL=?,ATTACHMENT=?,RECEIVER=?  WHERE ID=?";
