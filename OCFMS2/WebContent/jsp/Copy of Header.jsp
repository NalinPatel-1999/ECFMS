<%@page import="in.co.ocha.model.AppRoles"%>
<%@page import="in.co.common.model.RoleModel"%>
<%@page import="in.co.common.controller.LoginCtl"%>
...
<img src="<%=ORSView.IMG_FOLDER%>/logo.jpg">

<span style="font-size: 40px">Online Crime File Management System</span>

<HR>

<%
	if (userLoggedIn) {
		if (AppRoles.ADMIN == userBean.getRoleId()) {
%>
<table width="100%">
	<tr>
		<td width="80%" align="left"><a href="<%=ORSView.LOGIN_CTL%>">Home</a>
			...
			href="<%=ORSView.LOGIN_CTL%>">Logout</a>|</td>
...
<table width="100%">
	<tr>
		<td width="80%" align="left"><a href="<%=ORSView.LOGIN_CTL%>">Home</a>
			...
			href="<%=ORSView.CRIMEREPORT_CTL%>">Crime Report</a> | <a
			href="<%=ORSView.MISSINGPERSON_CTL%>">Missing Person</a> |
			<a href="<%=ORSView.MOSTWANTED_CTL%>">Most Wanted</a> | <a
			href="<%=ORSView.FEEDBACK_CTL%>">Feedback</b></a> | <a
			href="<%=ORSView.MAIL_CTL%>">Mail</b></a> | <a
			href="<%=ORSView.MY_PROFILE_CTL%>">My Profile</a> | <a
			href="<%=ORSView.LOGIN_CTL%>">Logout</a>|</td>
...
<table width="100%">
	<tr>
		<td width="80%" align="left"><a href="<%=ORSView.LOGIN_CTL%>">Home</a>
			...
			href="<%=ORSView.MISSINGPERSON_LIST_CTL%>">Missing Person List</a> |
			<a href="#">FAQ</a> |<a href="<%=ORSView.LOGIN_CTL%>">Login</a>|</td>
		<td align="right"><%=welcomeMsg%></td>
	</tr>
