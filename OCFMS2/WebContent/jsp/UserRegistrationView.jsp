...
<%@page import="in.co.ocha.controller.UserRegistrationCtl"%>
...
<Form action="<%=ORSView.USER_REGISTRATION_CTL%>" method="POST"
	...
	<table>
		<tr>
			<th>Register As*</th>
			<td> <input type="radio" name="roleId"
				value="<%=AppRoles.USER%>" checked="checked" > Civilian  <input type="radio"
				name="roleId" value="<%=AppRoles.INSPECTOR%>"> Inspector 
				<input type="radio" name="roleId" value="<%=AppRoles.COMMISSIONER%>"> Commissioner
			</td>
		</tr>
		<tr>
			<th>First Name*</th>
